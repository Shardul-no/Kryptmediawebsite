...
export default function Carousel({
  ...
  // ResizeObserver to get responsive width
  useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden p-4 mx-auto w-full max-w-[95vw] sm:max-w-md md:max-w-xl lg:max-w-2xl xl:max-w-3xl ${
