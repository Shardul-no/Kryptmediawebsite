...
const VideoProduction = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-20 bg-beige-100 text-charcoal overflow-hidden"
    >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg border border-teal-500/10 shadow-sm">
                ...
                <p className="text-charcoal-muted">Professional product photography that showcases your offerings in the best light.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-teal-500/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Explanatory Videos</h3>
                <p className="text-charcoal-muted">Clear, engaging videos that explain complex concepts and processes.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-teal-500/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Animated Videos</h3>
                <p className="text-charcoal-muted">Creative animations that bring your ideas to life with visual appeal.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-teal-500/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Social Media Content</h3>
                <p className="text-charcoal-muted">Short-form videos optimized for platforms like Instagram, TikTok, and YouTube.</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-12">
            ...
            <div className="flex space-x-6 overflow-x-auto pb-4 snap-x">
              {[
                ...
                <div
                  key={i}
                  className="snap-start min-w-[280px] bg-white border border-teal-500/10 shadow-lg p-4"
                >
                  <iframe
              ...
              <div className="snap-start min-w-[320px] bg-white border border-teal-500/10 shadow-lg p-4">
                <iframe
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-charcoal-muted">We develop concepts, write scripts, and plan every detail of your video project.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-charcoal-muted">Our professional crew captures high-quality footage with state-of-the-art equipment.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-charcoal-muted">We edit, add effects, and polish your video to perfection.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-charcoal-muted">We deliver your final video in multiple formats optimized for different platforms.</p>
                </div>
              </div>
            </div>
            <br></br>
