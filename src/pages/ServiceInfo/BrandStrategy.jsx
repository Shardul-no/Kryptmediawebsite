    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg border border-krypt-olive/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-krypt-charcoal">Market Research</h3>
                <p className="text-krypt-charcoal/55">Comprehensive analysis of your industry, competitors, and target audience.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-krypt-olive/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-krypt-charcoal">Brand Positioning</h3>
                <p className="text-krypt-charcoal/55">Strategic positioning that differentiates you from competitors.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-krypt-olive/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-krypt-charcoal">Value Proposition</h3>
                <p className="text-krypt-charcoal/55">Clear articulation of your unique value and benefits.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-krypt-olive/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-krypt-charcoal">Brand Voice & Personality</h3>
                <p className="text-krypt-charcoal/55">Consistent brand communication that resonates with your audience.</p>
              </div>
            </div>
          </motion.div>
          ...
          {/* Image Gallery */}
          <motion.div variants={itemVariants} className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-krypt-charcoal">Our Case Studies</h2>
            <div className="columns-1 md:columns-2 gap-6 space-y-6">
              {galleryImages.map((image, index) => (
                <motion.div
                  key={index}
                  className="group relative overflow-hidden rounded-lg bg-white border border-krypt-olive/10 break-inside-avoid mb-6"
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-krypt-charcoal mb-2">Discovery & Analysis</h3>
                  <p className="text-krypt-charcoal/55">We conduct thorough research to understand your business, market, and opportunities.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-krypt-charcoal mb-2">Strategy Development</h3>
                  <p className="text-krypt-charcoal/55">We develop comprehensive brand strategies based on our research findings.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-krypt-charcoal mb-2">Implementation Planning</h3>
                  <p className="text-krypt-charcoal/55">We create detailed implementation plans to execute your brand strategy.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-krypt-charcoal mb-2">Ongoing Support</h3>
                  <p className="text-krypt-charcoal/55">We provide continuous support to ensure your brand strategy evolves with your business.</p>
                </div>
              </div>
            </div>
            <br></br>
