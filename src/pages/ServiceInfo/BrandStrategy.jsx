          ...
          <motion.div variants={itemVariants} className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg border border-coffee/10 shadow-sm">
                ...
                <p className="text-slate-500">Comprehensive analysis of your industry, competitors, and target audience.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-coffee/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Brand Positioning</h3>
                <p className="text-slate-500">Strategic positioning that differentiates you from competitors.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-coffee/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Value Proposition</h3>
                <p className="text-slate-500">Clear articulation of your unique value and benefits.</p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-coffee/10 shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-charcoal">Brand Voice & Personality</h3>
                <p className="text-slate-500">Consistent brand communication that resonates with your audience.</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-12">
            ...
            <div className="columns-1 md:columns-2 gap-6 space-y-6">
              {galleryImages.map((image, index) => (
                <motion.div
                  key={index}
                  className="group relative overflow-hidden rounded-lg bg-white border border-coffee/10 break-inside-avoid mb-6"
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500">We conduct thorough research to understand your business, market, and opportunities.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500">We develop comprehensive brand strategies based on our research findings.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500">We create detailed implementation plans to execute your brand strategy.</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-500">We provide continuous support to ensure your brand strategy evolves with your business.</p>
                </div>
              </div>
            </div>
            <br></br>
